...
app.post('/api/userdetail', async (req, res) => { // tbhis line get the data from correct endpoint
    const accessTokenParams = {
        code: req.body.code,
        client_id: req.body.client_id,
        client_secret: req.body.client_secret,
    ...
    try {
        ...
        const getingUserDetail = await axios.get('https://meeting.zoho.in/api/v2/user.json',
                {
                    headers : {
