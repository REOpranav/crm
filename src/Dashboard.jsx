import { Menu, Row, Typography, Tooltip, Image, Space, Flex, Button, Col, message, Popover } from 'antd';
...
const Dashboard = ({ count }) => {
    ...
    let url = [
        'https://crm-server-opal.vercel.app/mongoDB/leads',
        'https://crm-server-opal.vercel.app/mongoDB/contacts',
        'https://crm-server-opal.vercel.app/mongoDB/accounts',
    ...
    return (
        <div className='dashBoardHead'>
            {profilView &&
                <div className={profilView && 'sideBarOpen'}>
                    <div id='closeProfileTab' onClick={() => setProfileView(!profilView)}> <p> <AiOutlineClose size={20} /> </p></div>
                    <div class='sidebarHeading'>
                        ...
                        <Row justify={'center'} id='profileName'>
                            Pranavavadivel
                        </Row>
                        <Row justify={'center'} id='ProfileUserID_org'>
                            <Col span={24} id='profile_user_id'>USER ID : {Math.floor(Math.random()*100000000000)}</Col>
                            <Col span={24} id='profile_training'>MKM Training</Col>
                        </Row>
                        <Row justify={'center'} id='profileAccount'>
                            <Col span={12} id='profileMyAccount' onClick={profilePage}><span id='profileMyAccountSpan'>My Account</span></Col>
                            <Col span={12} id='profilesignOut'><span>Sign Out</span></Col>
                        </Row>
                    </div>
                </div>
            }
